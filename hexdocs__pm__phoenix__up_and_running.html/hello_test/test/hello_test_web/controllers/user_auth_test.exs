defmodule HelloTestWeb.UserAuthTest do
  use HelloTestWeb.ConnCase, async: true

  alias HelloTest.Accounts
  alias HelloTestWeb.UserAuth
  import HelloTest.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, HelloTestWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      HelloTestWeb.Endpoint.subscribe(live_socket_id)
